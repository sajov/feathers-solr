...
class Service extends AdapterService {
  constructor (options = {}) {
    ...
    super({
        ...{
          ...
          escapeFn: function (key, value) { return {key, value} }
        },
        options,
  ...
  filterQuery (params = {}) {
    ...
    // inject default query options into $params
    const defaultQuery = Object.assign({}, this.options.defaultParams, filtered.query.$params);
    if (!_.isEmpty(defaultQuery)) filtered.query.$params = defaultQuery;

    // inject default search options into $params
  ...
  _get (id, params = {}) {
    ...
    // get
    return this.Model.post('query', core.jsonQuery(id, filters, query, paginate, this.options.escapeFn)).then(res => {
  ...
  _find (params = {}) {
    ...
    // find
    return this.Model.post('query', core.jsonQuery(null, filters, query, paginate, this.options.escapeFn)).then(res => core.responseFind(filters, query, paginate, res));
  }
  ...
  async _remove (id, params = {}) {
    ...
    return this.Model.post('update/json', query, this.options.commit).then(() => sel(dataToDelete));
  }
}
