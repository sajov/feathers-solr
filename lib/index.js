...
class Service extends AdapterService {
  ...
  _get(id, params = {}) {
    ...
    const query = { query: Object.assign({}, params.query) };
    return this.Model.post("query", utils.queryJson(id, query)).then(res => {
  ...
  _create(raw, params = {}) {
    ...
    return this.Model.post(
      ...
      if (Array.isArray(data) && !Array.isArray(raw)) data = data[0];
