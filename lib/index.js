...
class Service extends AdapterService {
  constructor (options = {}) {
    ...
    this.escapeFn = options.ecapeFn || function (key, value) { return {key, value} };
  }
  ...
  _get (id, params = {}) {
    ...
    // get
    return this.Model.post('query', core.jsonQuery(id, filters, query, paginate, this.escapeFn)).then(res => {
  ...
  _find (params = {}) {
    ...
    // find
    return this.Model.post('query', core.jsonQuery(null, filters, query, paginate, this.escapeFn)).then(res => core.responseFind(filters, query, paginate, res));
  }
